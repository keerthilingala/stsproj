...
<div class="formdata3">
<div align="center">
<form:form onsubmit="return validate()" action="Aforgotuid3" method="post" modelAttribute="name2">
<table>
<tr>
...
<%--<form:select path="qstn1" id="qstn1" class="secretquestion" >
...
<form:input path="ans1" id="ans1" placeholder="Answer" />
</td>
</tr>
<tr>
...
<%--<form:select path="qstn2" id="qstn2" class="secretquestion" >
<option  selected="selected" value="What is your favorite place?">What is your favourite place?</option>
...
<tr>
<td colspan="2" align="right">
<form:input path="ans2" id="ans2" placeholder="Answer" />
</td>
</tr>
...
<br><br>
<span style="color: green; font-size: 30px; font: bold;text-decoration: underline;">${message}</span><span style="font-size: 30px; font: bold;margin-left: 5px;">Your Id</span> 
<br><br>
